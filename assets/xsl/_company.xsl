		...
		<div class="uk-container uk-container-center">
			<div class="uk-grid">
				<div id="navigation" class="uk-width-medium-1-4">
					...
					<a class="nav-header" href="http://trialoftwo.slothsoft.net">http://trialoftwo.slothsoft.net</a>
					<ul class="uk-nav uk-nav-side">					<li><a href="#factsheet">Factsheet</a></li>
						...
						<li><a href="#logo">Logo &amp; Icon</a></li><li><a href="#quotes">Selected Articles</a></li><li><a href="#links">Additional Links</a></li>						<li><a href="#credits">Team</a></li>
				...
				<div id="content" class="uk-width-medium-3-4"><img src="images/header.png" class="header"/>					<div class="uk-grid">
						<div class="uk-width-medium-2-6">
							...
							<p>
								...
								<a href="http://http://trialoftwo.slothsoft.net">http://trialoftwo.slothsoft.net</a>
							</p>
							<p>
							...
							<p>
							<strong>Releases:</strong><br /><a href="sheet.php?p=trialoftwo">Trialoftwo</a><br />							</p>
							<p><strong>Address:</strong><br/>Bussardweg 23<br/>95445 Bayreuth<br/>Germany<br/>							</p> 
							<p>
