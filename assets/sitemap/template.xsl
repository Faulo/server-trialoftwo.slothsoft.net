...
<xsl:stylesheet version="1.0" xmlns="http://schema.slothsoft.net/farah/sitemap" xmlns:sfd="http://schema.slothsoft.net/farah/dictionary"
	...
	<xsl:template match="/*">
		<domain name="trialoftwo.slothsoft.net" vendor="oilcatz" module="trialoftwo.slothsoft.net" ref="pages/game" status-active="" status-public="" sfd:languages="en-us" version="1.1">
